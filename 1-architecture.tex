...
The \textbf{Hexagonal Architecture} \footnote{https://en.wikipedia.org/wiki/Hexagonal_architecture_(software)} in an architecture pattern that implements ideas of Domain-Driven-Design.
...
The Model-View-ViewModel \footnote{https://de.wikipedia.org/wiki/Model_View_ViewModel} (short \textbf{MVVM}) is a common pattern to decouple elements in systems with a GUI\@.
