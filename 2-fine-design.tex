...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=\linewidth]{active-scrape-service}}
...
These are comsumed by the \textit{AngularJS} templates.
...
% It is backed by a \texttt{HttpClient} \footnote{https://angular.dev/guide/http} from \textit{AngularJs}.that is used to perform the http-requests.
